  ...
  So = (e, t, r, n) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let i of Wu(t))
        !Ku.call(e, i) &&
          i !== r &&
          Gr(e, i, { get: () => t[i], enumerable: !(n = Hu(t, i)) || n.enumerable });
    return e;
  };
var _e = (e, t, r) => (
    (r = e != null ? Gu(Ju(e)) : {}),
...
function jt(e, t) {
  ...
  if (
    ((w += R), (I.precision = w), (r = Ae(O)), (n = r.charAt(0)), (o = Y(C)), Math.abs(o) < 15e14)
  ) {
  ...
  $o = fe(() => {
    ...
    Me = (function () {
      ...
      return function (n, i, o, s) {
        ...
        for (
          f = n.e - i.e, Ee = K.length, Ke = ve.length, C = new Qr(Qu), O = C.d = [], w = 0;
          K[w] == (ve[w] || 0);
...
function cc(e) {
  let t = {
    ...
    r = (...n) => {
      ...
      if (
        (n.length !== 0 && Qt.push([o, ...n]), Qt.length > lc && Qt.shift(), Gt.enabled(o) || i)
      ) {
...
function sn(e) {
  let t = e.showColors ? Qc : Gc,
    r;
  return (
    typeof $getTemplateParameters < 'u' ? (r = $getTemplateParameters(e, t)) : (r = Hc(e)),
    Wc(r, t)
  );
}
u();
...
function Kc(e) {
  ...
  for (let n of e) {
    ...
    o
      ? t.set(i, {
          ...n,
          argument: { ...n.argument, typeNames: zc(o.argument.typeNames, n.argument.typeNames) },
        })
      : t.set(i, n);
  }
...
var Nt = class e {
  ...
  async run(t, r) {
    let { value: n } = await this.interpretNode(t, r, this.#t, this.#s.snapshot(r.provider)).catch(
      (i) => qa(i)
    );
    return n;
  }
